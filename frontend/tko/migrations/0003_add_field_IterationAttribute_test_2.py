...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IterationAttribute.test_2'
        db.add_column('tko_iteration_attributes', 'test_2',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['tko.Test'], db_column='test_idx', null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IterationAttribute.test_2'
        db.delete_column('tko_iteration_attributes', 'test_idx')
    ...
    models = {
        ...
        'tko.iterationattribute': {
            ...
            'test': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True', 'db_column': "'id'"}),
            'test_2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tko.Test']", 'db_column': "'test_idx'", 'null': 'True'}),
