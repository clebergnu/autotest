...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        """
        Nothing is needed on this migration because only the ORM class
        reference is being renamed and nothing on the database is actually
        being touched
        """
        pass
    ...
    models = {
        ...
        'tko.iterationattribute': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tko.Test']", 'null': 'True', 'db_column': "'test_idx'"}),
