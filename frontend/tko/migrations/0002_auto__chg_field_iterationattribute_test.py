...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming column for 'IterationAttribute.test' to match new field type.
        db.rename_column('tko_iteration_attributes', 'test_idx', 'id')
        # Changing field 'IterationAttribute.test'
        db.alter_column('tko_iteration_attributes', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_column='id'))


    def backwards(self, orm):
        raise RuntimeError('Reverting this migration is not supported')
